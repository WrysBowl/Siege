...
public class Skeletal_Archer extends MobDropTable {
	...
	public Skeletal_Archer() {
		...
		super("Skeletal_Archer", 60, 70, 250, 255, new Reward[] {
				new Reward(new Bone()
				...
				new Reward(new HealthyReinforcedBow(Utils.randRarity()).getUpdatedItem(false), 0.25),
				new Reward(new ToughReinforcedBow(Utils.randRarity()).getUpdatedItem(false), 0.25),
				new Reward(new StrongReinforcedBow(Utils.randRarity()).getUpdatedItem(false), 0.25),
				new Reward(new LuckyReinforcedBow(Utils.randRarity()).getUpdatedItem(false), 0.25),
