...
public class ChestMimic3 extends MobDropTable {
    public ChestMimic3() {
        super("ChestMimic3", 350, 400, 350, 400, new Reward[]{
                ...
                new Reward(Leather.Companion.tier(2).getUpdatedItem(false).asQuantity(12), 15.0),
                new Reward(Wool.Companion.tier(2).getUpdatedItem(false).asQuantity(12), 15.0),
                new Reward(Bone.Companion.tier(2).getUpdatedItem(false).asQuantity(12), 15.0),

                new Reward(Leather.Companion.tier(3).getUpdatedItem(false).asQuantity(8), 15.0),
                new Reward(Wool.Companion.tier(3).getUpdatedItem(false).asQuantity(8), 15.0),
