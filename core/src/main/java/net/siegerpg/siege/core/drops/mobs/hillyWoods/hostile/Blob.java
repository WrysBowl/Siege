...
public class Blob extends MobDropTable {
    public Blob() {
        super("Blob", 7, 10, 7, 10, new Reward[]{
                ...
                new Reward(new LuckyStickyStick(Utils.randRarity()).getUpdatedItem(false), 2.0),
                new Reward(new StrongStickyStick(Utils.randRarity()).getUpdatedItem(false), 2.0),
                new Reward(new HealthyStickyStick(Utils.randRarity()).getUpdatedItem(false), 2.0),
                new Reward(new HealingStickyStick(Utils.randRarity()).getUpdatedItem(false), 2.0),
                new Reward(new ToughStickyStick(Utils.randRarity()).getUpdatedItem(false), 2.0),

                new Reward(new StickyStick(50).getUpdatedItem(false), 5.0),
                new Reward(new LuckyStickyStick(50).getUpdatedItem(false), 2.0),
                new Reward(new StrongStickyStick(50).getUpdatedItem(false), 2.0),
                new Reward(new HealthyStickyStick(50).getUpdatedItem(false), 2.0),
                new Reward(new HealingStickyStick(50).getUpdatedItem(false), 2.0),
                new Reward(new ToughStickyStick(50).getUpdatedItem(false), 2.0),

                new Reward(new SlimyHelmet(50).getUpdatedItem(false), 5.0),
                new Reward(new SlimyChestplate(50).getUpdatedItem(false), 5.0),
                new Reward(new SlimyLeggings(50).getUpdatedItem(false), 5.0),
                new Reward(new SlimyBoots(50).getUpdatedItem(false), 5.0),
