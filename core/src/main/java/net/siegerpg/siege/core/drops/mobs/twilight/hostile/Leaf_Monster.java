...
public class Leaf_Monster extends MobDropTable {
    public Leaf_Monster() {
        super("Leaf_Monster", 40, 50, 35, 45, new Reward[]{
                new Reward(SparklingLeaves.Companion.tier(2).getUpdatedItem(false).asQuantity(16), 25.0),
                new Reward(SparklingLeaves.Companion.tier(3).getUpdatedItem(false), 5.0),
                new Reward(FairyDust.Companion.tier(1).getUpdatedItem(false).asQuantity(16), 50.0),
                new Reward(FairyDust.Companion.tier(2).getUpdatedItem(false), 10.0),
                new Reward(PlantMatter.Companion.tier(2).getUpdatedItem(false).asQuantity(16), 50.0),
