...
public class Orc extends MobDropTable {
	...
	public Orc() {
		...
		super("Orc", 55, 59, 60, 64, new Reward[] {
				...
				new Reward(new Leather().getUpdatedItem(false).asQuantity(4), 2.5),
				new Reward(new Bone().getUpdatedItem(false), 50.0),
				new Reward(new Bone().getUpdatedItem(false).asQuantity(4), 2.5),
				...
				new Reward(new ToughBoneHelmet(30).getUpdatedItem(false), 0.10),
				new Reward(new ToughBoneChestplate(30).getUpdatedItem(false), 0.10),
				new Reward(new ToughBoneLeggings(30).getUpdatedItem(false), 0.10),
				new Reward(new ToughBoneBoots(30).getUpdatedItem(false), 0.10),

				new Reward(new HealingBoneHelmet(30).getUpdatedItem(false), 0.10),
				new Reward(new HealingBoneChestplate(30).getUpdatedItem(false), 0.10),
				new Reward(new HealingBoneLeggings(30).getUpdatedItem(false), 0.10),
				new Reward(new HealingBoneBoots(30).getUpdatedItem(false), 0.10),

				new Reward(new HealthyBoneHelmet(30).getUpdatedItem(false), 0.10),
				new Reward(new HealthyBoneChestplate(30).getUpdatedItem(false), 0.10),
				new Reward(new HealthyBoneLeggings(30).getUpdatedItem(false), 0.10),
				new Reward(new HealthyBoneBoots(30).getUpdatedItem(false), 0.10),

				new Reward(new StrongBoneHelmet(30).getUpdatedItem(false), 0.10),
				new Reward(new StrongBoneChestplate(30).getUpdatedItem(false), 0.10),
				new Reward(new StrongBoneLeggings(30).getUpdatedItem(false), 0.10),
				new Reward(new StrongBoneBoots(30).getUpdatedItem(false), 0.10),

				new Reward(new LuckyBoneHelmet(30).getUpdatedItem(false), 0.10),
				new Reward(new LuckyBoneChestplate(30).getUpdatedItem(false), 0.10),
				new Reward(new LuckyBoneLeggings(30).getUpdatedItem(false), 0.10),
				new Reward(new LuckyBoneBoots(30).getUpdatedItem(false), 0.10),
				...
				new Reward(new DoubleBladedAxe(80).getUpdatedItem(false), 0.25),
				new Reward(new LuckyDoubleBladedAxe(50).getUpdatedItem(false), 0.05),
				new Reward(new ToughDoubleBladedAxe(50).getUpdatedItem(false), 0.05),
				new Reward(new StrongDoubleBladedAxe(50).getUpdatedItem(false), 0.05),
				new Reward(new HealingDoubleBladedAxe(50).getUpdatedItem(false), 0.05),
				new Reward(new HealthyDoubleBladedAxe(50).getUpdatedItem(false), 0.05),

				new Reward(new DoubleBladedAxe(Utils.randRarity()).getUpdatedItem(false), 0.50),
				new Reward(new LuckyDoubleBladedAxe(Utils.randRarity()).getUpdatedItem(false), 0.10),
				new Reward(new ToughDoubleBladedAxe(Utils.randRarity()).getUpdatedItem(false), 0.10),
				new Reward(new StrongDoubleBladedAxe(Utils.randRarity()).getUpdatedItem(false), 0.10),
				new Reward(new HealingDoubleBladedAxe(Utils.randRarity()).getUpdatedItem(false), 0.10),
				new Reward(new HealthyDoubleBladedAxe(Utils.randRarity()).getUpdatedItem(false), 0.10),

				new Reward(new DavyJonesKey(0).getUpdatedItem(false), 1.5),
