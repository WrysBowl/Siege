...
public class Orc extends MobDropTable {
	...
	public Orc() {
		...
		super("Orc", 55, 59, 119, 125, new Reward[] {
				...
				new Reward(new ToughBoneLeggings(30).getUpdatedItem(false), 0.025),
				new Reward(new ToughBoneBoots(30).getUpdatedItem(false), 0.025),

				new Reward(new HealingBoneHelmet(30).getUpdatedItem(false), 0.025),
				new Reward(new HealingBoneChestplate(30).getUpdatedItem(false), 0.025),
				new Reward(new HealingBoneLeggings(30).getUpdatedItem(false), 0.025),
				new Reward(new HealingBoneBoots(30).getUpdatedItem(false), 0.025),

				new Reward(new HealthyBoneHelmet(30).getUpdatedItem(false), 0.025),
				new Reward(new HealthyBoneChestplate(30).getUpdatedItem(false), 0.025),
				new Reward(new HealthyBoneLeggings(30).getUpdatedItem(false), 0.025),
				new Reward(new HealthyBoneBoots(30).getUpdatedItem(false), 0.025),

				new Reward(new StrongBoneHelmet(30).getUpdatedItem(false), 0.025),
				new Reward(new StrongBoneChestplate(30).getUpdatedItem(false), 0.025),
				new Reward(new StrongBoneLeggings(30).getUpdatedItem(false), 0.025),
				new Reward(new StrongBoneBoots(30).getUpdatedItem(false), 0.025),

				new Reward(new LuckyBoneHelmet(30).getUpdatedItem(false), 0.025),
				new Reward(new LuckyBoneChestplate(30).getUpdatedItem(false), 0.025),
				new Reward(new LuckyBoneLeggings(30).getUpdatedItem(false), 0.025),
				new Reward(new LuckyBoneBoots(30).getUpdatedItem(false), 0.025),
				...
				new Reward(new HealingDoubleBladedAxe(50).getUpdatedItem(false), 0.01),
				new Reward(new HealthyDoubleBladedAxe(50).getUpdatedItem(false), 0.01),

				new Reward(new DoubleBladedAxe(Utils.randRarity()).getUpdatedItem(false), 0.10),
				new Reward(new LuckyDoubleBladedAxe(Utils.randRarity()).getUpdatedItem(false), 0.025),
				new Reward(new ToughDoubleBladedAxe(Utils.randRarity()).getUpdatedItem(false), 0.025),
				new Reward(new StrongDoubleBladedAxe(Utils.randRarity()).getUpdatedItem(false), 0.025),
