...
public class RockSpirit extends MobDropTable {
	...
	public RockSpirit() {
		...
		super("RockSpirit", 67, 70, 66, 69, new Reward[] {
				...
				new Reward(new GrieferChestplate(100).getUpdatedItem(false), 0.30),
				new Reward(new GrieferChestplate(80).getUpdatedItem(false), 1.5),

				new Reward(new JaggedTunic(Utils.randRarity()).getUpdatedItem(false), 4.0),
				new Reward(new JaggedTunic(100).getUpdatedItem(false), 0.30),
				new Reward(new JaggedTunic(80).getUpdatedItem(false), 1.5),
				...
				new Reward(new PebbleShooter(100).getUpdatedItem(false), 0.30),
				new Reward(new PebbleShooter(80).getUpdatedItem(false), 0.75),
				new Reward(new LuckyPebbleShooter(50).getUpdatedItem(false), 0.10),
				new Reward(new ToughPebbleShooter(50).getUpdatedItem(false), 0.10),
				new Reward(new StrongPebbleShooter(50).getUpdatedItem(false), 0.10),
				new Reward(new HealingPebbleShooter(50).getUpdatedItem(false), 0.10),
				new Reward(new HealthyPebbleShooter(50).getUpdatedItem(false), 0.10),

				new Reward(new RockWand(Utils.randRarity()).getUpdatedItem(false), 4.0),
				new Reward(new LuckyRockWand(Utils.randRarity()).getUpdatedItem(false), 0.05),
				new Reward(new ToughRockWand(Utils.randRarity()).getUpdatedItem(false), 0.05),
				new Reward(new StrongRockWand(Utils.randRarity()).getUpdatedItem(false), 0.05),
				new Reward(new HealingRockWand(Utils.randRarity()).getUpdatedItem(false), 0.05),
				new Reward(new HealthyRockWand(Utils.randRarity()).getUpdatedItem(false), 0.05),
				new Reward(new RockWand(100).getUpdatedItem(false), 0.30),
				new Reward(new RockWand(80).getUpdatedItem(false), 0.75),
				new Reward(new LuckyRockWand(50).getUpdatedItem(false), 0.10),
				new Reward(new ToughRockWand(50).getUpdatedItem(false), 0.10),
				new Reward(new StrongRockWand(50).getUpdatedItem(false), 0.10),
				new Reward(new HealingRockWand(50).getUpdatedItem(false), 0.10),
				new Reward(new HealthyRockWand(50).getUpdatedItem(false), 0.10),

				new Reward(new LichKey(0).getUpdatedItem(false), 1.5),
