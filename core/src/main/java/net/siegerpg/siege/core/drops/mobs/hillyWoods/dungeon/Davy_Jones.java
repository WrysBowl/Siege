...
public class Davy_Jones extends MobDropTable {
	...
	public Davy_Jones() {
		...
		super("Davy_Jones", 15000, 17500, 35000, 40000, new Reward[] {
				...
				new Reward(new LuckyTrident(Utils.randRarity()).getUpdatedItem(false), 1.0),
				new Reward(new ToughTrident(Utils.randRarity()).getUpdatedItem(false), 1.0),
				new Reward(new StrongTrident(Utils.randRarity()).getUpdatedItem(false), 1.0),
				new Reward(new HealingTrident(Utils.randRarity()).getUpdatedItem(false), 1.0),
				new Reward(new HealthyTrident(Utils.randRarity()).getUpdatedItem(false), 1.0),

				new Reward(new WarHammer(100).getUpdatedItem(false), 5.0),
				new Reward(new WarHammer(80).getUpdatedItem(false), 20.0),
				new Reward(new LuckyWarHammer(Utils.randRarity()).getUpdatedItem(false), 1.0),
				new Reward(new ToughWarHammer(Utils.randRarity()).getUpdatedItem(false), 1.0),
				new Reward(new StrongWarHammer(Utils.randRarity()).getUpdatedItem(false), 1.0),
				new Reward(new HealingWarHammer(Utils.randRarity()).getUpdatedItem(false), 1.0),
				new Reward(new HealthyWarHammer(Utils.randRarity()).getUpdatedItem(false), 1.0),
				...
				new Reward(new ToughBoneHelmet(50).getUpdatedItem(false), 1.0),
				new Reward(new ToughBoneChestplate(50).getUpdatedItem(false), 1.0),
				new Reward(new ToughBoneLeggings(50).getUpdatedItem(false), 1.0),
				new Reward(new ToughBoneBoots(50).getUpdatedItem(false), 1.0),

				new Reward(new HealingBoneHelmet(50).getUpdatedItem(false), 1.0),
				new Reward(new HealingBoneChestplate(50).getUpdatedItem(false), 1.0),
				new Reward(new HealingBoneLeggings(50).getUpdatedItem(false), 1.0),
				new Reward(new HealingBoneBoots(50).getUpdatedItem(false), 1.0),

				new Reward(new HealthyBoneHelmet(50).getUpdatedItem(false), 1.0),
				new Reward(new HealthyBoneChestplate(50).getUpdatedItem(false), 1.0),
				new Reward(new HealthyBoneLeggings(50).getUpdatedItem(false), 1.0),
				new Reward(new HealthyBoneBoots(50).getUpdatedItem(false), 1.0),

				new Reward(new StrongBoneHelmet(50).getUpdatedItem(false), 1.0),
				new Reward(new StrongBoneChestplate(50).getUpdatedItem(false), 1.0),
				new Reward(new StrongBoneLeggings(50).getUpdatedItem(false), 1.0),
				new Reward(new StrongBoneBoots(50).getUpdatedItem(false), 1.0),

				new Reward(new LuckyBoneHelmet(50).getUpdatedItem(false), 1.0),
				new Reward(new LuckyBoneChestplate(50).getUpdatedItem(false), 1.0),
				new Reward(new LuckyBoneLeggings(50).getUpdatedItem(false), 1.0),
				new Reward(new LuckyBoneBoots(50).getUpdatedItem(false), 1.0),
				...
				new Reward(new ToughBoneLeggings(Utils.randRarity()).getUpdatedItem(false), 1.0),
				new Reward(new ToughBoneBoots(Utils.randRarity()).getUpdatedItem(false), 1.0),

				new Reward(new HealingBoneHelmet(Utils.randRarity()).getUpdatedItem(false), 1.0),
				new Reward(new HealingBoneChestplate(Utils.randRarity()).getUpdatedItem(false), 1.0),
				new Reward(new HealingBoneLeggings(Utils.randRarity()).getUpdatedItem(false), 1.0),
				new Reward(new HealingBoneBoots(Utils.randRarity()).getUpdatedItem(false), 1.0),

				new Reward(new HealthyBoneHelmet(Utils.randRarity()).getUpdatedItem(false), 1.0),
				new Reward(new HealthyBoneChestplate(Utils.randRarity()).getUpdatedItem(false), 1.0),
				new Reward(new HealthyBoneLeggings(Utils.randRarity()).getUpdatedItem(false), 1.0),
				new Reward(new HealthyBoneBoots(Utils.randRarity()).getUpdatedItem(false), 1.0),

				new Reward(new StrongBoneHelmet(Utils.randRarity()).getUpdatedItem(false), 1.0),
				new Reward(new StrongBoneChestplate(Utils.randRarity()).getUpdatedItem(false), 1.0),
				new Reward(new StrongBoneLeggings(Utils.randRarity()).getUpdatedItem(false), 1.0),
				new Reward(new StrongBoneBoots(Utils.randRarity()).getUpdatedItem(false), 1.0),

				new Reward(new LuckyBoneHelmet(Utils.randRarity()).getUpdatedItem(false), 1.0),
				new Reward(new LuckyBoneChestplate(Utils.randRarity()).getUpdatedItem(false), 1.0),
				new Reward(new LuckyBoneLeggings(Utils.randRarity()).getUpdatedItem(false), 1.0),
				new Reward(new LuckyBoneBoots(Utils.randRarity()).getUpdatedItem(false), 1.0),
