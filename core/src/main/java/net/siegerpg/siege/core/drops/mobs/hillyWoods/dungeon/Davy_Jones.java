...
public class Davy_Jones extends MobDropTable {
    public Davy_Jones() {
        super("Davy_Jones", 1400, 1480, 1500, 1580, new Reward[]{
                ...
                new Reward(new LuckyTrident(100).getUpdatedItem(false), 5.0),
                new Reward(new StrongTrident(100).getUpdatedItem(false), 5.0),
                new Reward(new HealingTrident(100).getUpdatedItem(false), 5.0),
                new Reward(new ToughTrident(100).getUpdatedItem(false), 5.0),
                new Reward(new HealthyTrident(100).getUpdatedItem(false), 5.0),
                ...
                new Reward(new LuckyWarHammer(100).getUpdatedItem(false), 5.0),
                new Reward(new StrongWarHammer(100).getUpdatedItem(false), 5.0),
                new Reward(new HealingWarHammer(100).getUpdatedItem(false), 5.0),
                new Reward(new ToughWarHammer(100).getUpdatedItem(false), 5.0),
                new Reward(new HealthyWarHammer(100).getUpdatedItem(false), 5.0),
