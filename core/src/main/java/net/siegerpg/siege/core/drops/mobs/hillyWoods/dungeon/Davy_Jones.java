...
public class Davy_Jones extends MobDropTable {
    public Davy_Jones() {
        super("Davy_Jones", 1400, 1480, 1500, 1580, new Reward[]{
                ...
                new Reward(new Trident(100).getUpdatedItem(false), 2.0),
                new Reward(new LuckyTrident(100).getUpdatedItem(false), 2.0),
                new Reward(new StrongTrident(100).getUpdatedItem(false), 2.0),
                new Reward(new HealingTrident(100).getUpdatedItem(false), 2.0),
                new Reward(new ToughTrident(100).getUpdatedItem(false), 2.0),
                new Reward(new HealthyTrident(100).getUpdatedItem(false), 2.0),

                new Reward(new Trident(80).getUpdatedItem(false), 20.0),
                new Reward(new LuckyTrident(80).getUpdatedItem(false), 20.0),
                new Reward(new StrongTrident(80).getUpdatedItem(false), 20.0),
                new Reward(new HealingTrident(80).getUpdatedItem(false), 20.0),
                new Reward(new ToughTrident(80).getUpdatedItem(false), 20.0),
                new Reward(new HealthyTrident(80).getUpdatedItem(false), 20.0),

                new Reward(new WarHammer(100).getUpdatedItem(false), 2.0),
                new Reward(new LuckyWarHammer(100).getUpdatedItem(false), 2.0),
                new Reward(new StrongWarHammer(100).getUpdatedItem(false), 2.0),
                new Reward(new HealingWarHammer(100).getUpdatedItem(false), 2.0),
                new Reward(new ToughWarHammer(100).getUpdatedItem(false), 2.0),
                new Reward(new HealthyWarHammer(100).getUpdatedItem(false), 2.0),

                new Reward(new WarHammer(80).getUpdatedItem(false), 20.0),
                new Reward(new LuckyWarHammer(80).getUpdatedItem(false), 20.0),
                new Reward(new StrongWarHammer(80).getUpdatedItem(false), 20.0),
                new Reward(new HealingWarHammer(80).getUpdatedItem(false), 20.0),
                new Reward(new ToughWarHammer(80).getUpdatedItem(false), 20.0),
                new Reward(new HealthyWarHammer(80).getUpdatedItem(false), 20.0),
