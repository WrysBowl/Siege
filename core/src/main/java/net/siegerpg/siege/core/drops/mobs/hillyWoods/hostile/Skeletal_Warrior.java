...
public class Skeletal_Warrior extends MobDropTable {
	...
	public Skeletal_Warrior() {
		...
		super("Skeletal_Warrior", 80, 90, 60, 70, new Reward[] {
				...
				new Reward(new WoodenSword(Utils.randRarity()).getUpdatedItem(false), 1.0),
				new Reward(new HealingWoodenSword(Utils.randRarity()).getUpdatedItem(false), 1.0),
				new Reward(new HealthyWoodenSword(Utils.randRarity()).getUpdatedItem(false), 1.0),
				new Reward(new ToughWoodenSword(Utils.randRarity()).getUpdatedItem(false), 1.0),
				new Reward(new StrongWoodenSword(Utils.randRarity()).getUpdatedItem(false), 1.0),
				new Reward(new LuckyWoodenSword(Utils.randRarity()).getUpdatedItem(false), 1.0),

				new Reward(new ScrapShard(Utils.randRarity()).getUpdatedItem(false), 0.50),
				new Reward(new HealingScrapShard(Utils.randRarity()).getUpdatedItem(false), 0.50),
				new Reward(new HealthyScrapShard(Utils.randRarity()).getUpdatedItem(false), 0.50),
				new Reward(new ToughScrapShard(Utils.randRarity()).getUpdatedItem(false), 0.50),
				new Reward(new StrongScrapShard(Utils.randRarity()).getUpdatedItem(false), 0.50),
				new Reward(new LuckyScrapShard(Utils.randRarity()).getUpdatedItem(false), 0.50),

				new Reward(new SplinteredBone(Utils.randRarity()).getUpdatedItem(false), 0.25),
				new Reward(
						new HealingSplinteredBone(Utils.randRarity()).getUpdatedItem(false), 0.25),
				new Reward(
						new HealthySplinteredBone(Utils.randRarity()).getUpdatedItem(false), 0.25),
				new Reward(new ToughSplinteredBone(Utils.randRarity()).getUpdatedItem(false), 0.25),
				new Reward(new StrongSplinteredBone(Utils.randRarity()).getUpdatedItem(false), 0.25),
				new Reward(new LuckySplinteredBone(Utils.randRarity()).getUpdatedItem(false), 0.25),
