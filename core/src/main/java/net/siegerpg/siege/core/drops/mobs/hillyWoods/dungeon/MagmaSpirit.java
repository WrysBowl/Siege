...
public class MagmaSpirit extends MobDropTable {
	...
	public MagmaSpirit() {
		...
		super("MagmaSpirit", 1500, 1800, 7500, 10000, new Reward[] {
				...
				new Reward(new ToughMagmaHelmet(50).getUpdatedItem(false), 1.0),
				new Reward(new ToughMagmaChestplate(50).getUpdatedItem(false), 1.0),
				new Reward(new ToughMagmaLeggings(50).getUpdatedItem(false), 1.0),
				new Reward(new ToughMagmaBoots(50).getUpdatedItem(false), 1.0),

				new Reward(new HealingMagmaHelmet(50).getUpdatedItem(false), 1.0),
				new Reward(new HealingMagmaChestplate(50).getUpdatedItem(false), 1.0),
				new Reward(new HealingMagmaLeggings(50).getUpdatedItem(false), 1.0),
				new Reward(new HealingMagmaBoots(50).getUpdatedItem(false), 1.0),

				new Reward(new HealthyMagmaHelmet(50).getUpdatedItem(false), 1.0),
				new Reward(new HealthyMagmaChestplate(50).getUpdatedItem(false), 1.0),
				new Reward(new HealthyMagmaLeggings(50).getUpdatedItem(false), 1.0),
				new Reward(new HealthyMagmaBoots(50).getUpdatedItem(false), 1.0),

				new Reward(new StrongMagmaHelmet(50).getUpdatedItem(false), 1.0),
				new Reward(new StrongMagmaChestplate(50).getUpdatedItem(false), 1.0),
				new Reward(new StrongMagmaLeggings(50).getUpdatedItem(false), 1.0),
				new Reward(new StrongMagmaBoots(50).getUpdatedItem(false), 1.0),

				new Reward(new LuckyMagmaHelmet(50).getUpdatedItem(false), 1.0),
				new Reward(new LuckyMagmaChestplate(50).getUpdatedItem(false), 1.0),
				new Reward(new LuckyMagmaLeggings(50).getUpdatedItem(false), 1.0),
				new Reward(new LuckyMagmaBoots(50).getUpdatedItem(false), 1.0),
				...
				new Reward(new ToughMagmaHelmet(Utils.randRarity()).getUpdatedItem(false), 2.0),
				new Reward(new ToughMagmaChestplate(Utils.randRarity()).getUpdatedItem(false), 2.0),
				new Reward(new ToughMagmaLeggings(Utils.randRarity()).getUpdatedItem(false), 2.0),
				new Reward(new ToughMagmaBoots(Utils.randRarity()).getUpdatedItem(false), 2.0),

				new Reward(new HealingMagmaHelmet(Utils.randRarity()).getUpdatedItem(false), 2.0),
				new Reward(new HealingMagmaChestplate(Utils.randRarity()).getUpdatedItem(false), 2.0),
				new Reward(new HealingMagmaLeggings(Utils.randRarity()).getUpdatedItem(false), 2.0),
				new Reward(new HealingMagmaBoots(Utils.randRarity()).getUpdatedItem(false), 2.0),

				new Reward(new HealthyMagmaHelmet(Utils.randRarity()).getUpdatedItem(false), 2.0),
				new Reward(new HealthyMagmaChestplate(Utils.randRarity()).getUpdatedItem(false), 2.0),
				new Reward(new HealthyMagmaLeggings(Utils.randRarity()).getUpdatedItem(false), 2.0),
				new Reward(new HealthyMagmaBoots(Utils.randRarity()).getUpdatedItem(false), 2.0),

				new Reward(new StrongMagmaHelmet(Utils.randRarity()).getUpdatedItem(false), 2.0),
				new Reward(new StrongMagmaChestplate(Utils.randRarity()).getUpdatedItem(false), 2.0),
				new Reward(new StrongMagmaLeggings(Utils.randRarity()).getUpdatedItem(false), 2.0),
				new Reward(new StrongMagmaBoots(Utils.randRarity()).getUpdatedItem(false), 2.0),

				new Reward(new LuckyMagmaHelmet(Utils.randRarity()).getUpdatedItem(false), 2.0),
				new Reward(new LuckyMagmaChestplate(Utils.randRarity()).getUpdatedItem(false), 2.0),
				new Reward(new LuckyMagmaLeggings(Utils.randRarity()).getUpdatedItem(false), 2.0),
				new Reward(new LuckyMagmaBoots(Utils.randRarity()).getUpdatedItem(false), 2.0),

				new Reward(new Torch(100).getUpdatedItem(false), 20.0),
				new Reward(new Torch(Utils.randRarity()).getUpdatedItem(false), 25.0),
				new Reward(new LuckyTorch(Utils.randRarity()).getUpdatedItem(false), 2.0),
				new Reward(new ToughTorch(Utils.randRarity()).getUpdatedItem(false), 2.0),
				new Reward(new StrongTorch(Utils.randRarity()).getUpdatedItem(false), 2.0),
				new Reward(new HealingTorch(Utils.randRarity()).getUpdatedItem(false), 2.0),
				new Reward(new HealthyTorch(Utils.randRarity()).getUpdatedItem(false), 2.0),
