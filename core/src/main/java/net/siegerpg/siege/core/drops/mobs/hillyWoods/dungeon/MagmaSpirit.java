...
public class MagmaSpirit extends MobDropTable {
	...
	public MagmaSpirit() {
		...
		super("MagmaSpirit", 1500, 1800, 5500, 7500, new Reward[] {
				...
				new Reward(new ToughMagmaHelmet(Utils.randRarity()).getUpdatedItem(false), 0.20),
				new Reward(new ToughMagmaChestplate(Utils.randRarity()).getUpdatedItem(false), 0.20),
				new Reward(new ToughMagmaLeggings(Utils.randRarity()).getUpdatedItem(false), 0.20),
				new Reward(new ToughMagmaBoots(Utils.randRarity()).getUpdatedItem(false), 0.20),

				new Reward(new HealingMagmaHelmet(Utils.randRarity()).getUpdatedItem(false), 0.20),
				new Reward(new HealingMagmaChestplate(Utils.randRarity()).getUpdatedItem(false), 0.20),
				new Reward(new HealingMagmaLeggings(Utils.randRarity()).getUpdatedItem(false), 0.20),
				new Reward(new HealingMagmaBoots(Utils.randRarity()).getUpdatedItem(false), 0.20),

				new Reward(new HealthyMagmaHelmet(Utils.randRarity()).getUpdatedItem(false), 0.20),
				new Reward(new HealthyMagmaChestplate(Utils.randRarity()).getUpdatedItem(false), 0.20),
				new Reward(new HealthyMagmaLeggings(Utils.randRarity()).getUpdatedItem(false), 0.20),
				new Reward(new HealthyMagmaBoots(Utils.randRarity()).getUpdatedItem(false), 0.20),

				new Reward(new StrongMagmaHelmet(Utils.randRarity()).getUpdatedItem(false), 0.20),
				new Reward(new StrongMagmaChestplate(Utils.randRarity()).getUpdatedItem(false), 0.20),
				new Reward(new StrongMagmaLeggings(Utils.randRarity()).getUpdatedItem(false), 0.20),
				new Reward(new StrongMagmaBoots(Utils.randRarity()).getUpdatedItem(false), 0.20),

				new Reward(new LuckyMagmaHelmet(Utils.randRarity()).getUpdatedItem(false), 0.20),
				new Reward(new LuckyMagmaChestplate(Utils.randRarity()).getUpdatedItem(false), 0.20),
				new Reward(new LuckyMagmaLeggings(Utils.randRarity()).getUpdatedItem(false), 0.20),
				new Reward(new LuckyMagmaBoots(Utils.randRarity()).getUpdatedItem(false), 0.20),

				new Reward(new Torch(100).getUpdatedItem(false), 20.0),
				new Reward(new Torch(Utils.randRarity()).getUpdatedItem(false), 21.0),
				new Reward(new LuckyTorch(Utils.randRarity()).getUpdatedItem(false), 0.20),
				new Reward(new ToughTorch(Utils.randRarity()).getUpdatedItem(false), 0.20),
				new Reward(new StrongTorch(Utils.randRarity()).getUpdatedItem(false), 0.20),
				new Reward(new HealingTorch(Utils.randRarity()).getUpdatedItem(false), 0.20),
				new Reward(new HealthyTorch(Utils.randRarity()).getUpdatedItem(false), 0.20),
