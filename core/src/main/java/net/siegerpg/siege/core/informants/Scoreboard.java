...
public class Scoreboard {
    public static void updateScoreboard(Player p) {
        ...
        double levelPercent = Utils.round((Levels.getExp(p)/ Levels.getExpCeiling(p)), 1); //for score #13
        ...
        o.getScore(Utils.tacc("&7\u2560 Level &5" + Levels.getLevel(p) + "&d(" + levelPercent + "%)")).setScore(12);
