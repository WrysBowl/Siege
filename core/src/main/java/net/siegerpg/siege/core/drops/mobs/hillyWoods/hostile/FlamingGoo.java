...
public class FlamingGoo extends MobDropTable {
    public FlamingGoo() {
        super("FlamingGoo", 3, 6, 5, 7, new Reward[]{
                ...
                new Reward(new MagmaHelmet(30).getUpdatedItem(false), 3.0),
                new Reward(new MagmaChestplate(30).getUpdatedItem(false), 3.0),
                new Reward(new MagmaLeggings(30).getUpdatedItem(false), 3.0),
                new Reward(new MagmaBoots(30).getUpdatedItem(false), 3.0),
