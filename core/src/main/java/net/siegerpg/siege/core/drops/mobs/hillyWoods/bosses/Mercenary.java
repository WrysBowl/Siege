...
public class Mercenary extends MobDropTable {
	...
	public Mercenary() {
		...
		super("Mercenary", 55, 58, 805, 808, new Reward[] {
				...
				new Reward(new LuckyRefinedDagger(Utils.randRarity()).getUpdatedItem(false), 0.10),
				new Reward(new ToughRefinedDagger(Utils.randRarity()).getUpdatedItem(false), 0.10),
				new Reward(new StrongRefinedDagger(Utils.randRarity()).getUpdatedItem(false), 0.10),
				new Reward(new HealingRefinedDagger(Utils.randRarity()).getUpdatedItem(false), 0.10),
				new Reward(new HealthyRefinedDagger(Utils.randRarity()).getUpdatedItem(false), 0.10),
