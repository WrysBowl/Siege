    ...
    public static HashMap<String[], WebstorePackage> packages = new HashMap<>(){
        {
            ...
            put(new String[]{"booster", "GOLD", "1.2"}, new HeroRank());
            put(new String[]{"booster", "GOLD", "1.5"}, new HeroRank());
            put(new String[]{"booster", "GOLD", "2.0"}, new HeroRank());
            put(new String[]{"booster", "EXP", "1.2"}, new HeroRank());
            put(new String[]{"booster", "EXP", "1.5"}, new HeroRank());
            put(new String[]{"booster", "EXP", "2.0"}, new HeroRank());
