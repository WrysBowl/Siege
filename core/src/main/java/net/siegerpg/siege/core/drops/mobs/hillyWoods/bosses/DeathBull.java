...
public class DeathBull extends MobDropTable {
	...
	public DeathBull() {
		...
		super("DeathBull", 37, 40, 136, 139, new Reward[] {
				...
				new Reward(new LeatherHelmet(80).getUpdatedItem(false), 0.10),
				new Reward(new LeatherChestplate(80).getUpdatedItem(false), 0.10),
				new Reward(new LeatherLeggings(80).getUpdatedItem(false), 0.10),
				new Reward(new LeatherBoots(80).getUpdatedItem(false), 0.10),

				new Reward(new ToughHardenedLeatherHelmet(50).getUpdatedItem(false), 0.025),
				new Reward(new ToughHardenedLeatherChestplate(50).getUpdatedItem(false), 0.025),
				new Reward(new ToughHardenedLeatherLeggings(50).getUpdatedItem(false), 0.025),
				new Reward(new ToughHardenedLeatherBoots(50).getUpdatedItem(false), 0.025),

				new Reward(new HealingHardenedLeatherHelmet(50).getUpdatedItem(false), 0.025),
				new Reward(new HealingHardenedLeatherChestplate(50).getUpdatedItem(false), 0.025),
				new Reward(new HealingHardenedLeatherLeggings(50).getUpdatedItem(false), 0.025),
				new Reward(new HealingHardenedLeatherBoots(50).getUpdatedItem(false), 0.025),

				new Reward(new HealthyHardenedLeatherHelmet(50).getUpdatedItem(false), 0.025),
				new Reward(new HealthyHardenedLeatherChestplate(50).getUpdatedItem(false), 0.025),
				new Reward(new HealthyHardenedLeatherLeggings(50).getUpdatedItem(false), 0.025),
				new Reward(new HealthyHardenedLeatherBoots(50).getUpdatedItem(false), 0.025),

				new Reward(new StrongHardenedLeatherHelmet(50).getUpdatedItem(false), 0.025),
				new Reward(new StrongHardenedLeatherChestplate(50).getUpdatedItem(false), 0.025),
				new Reward(new StrongHardenedLeatherLeggings(50).getUpdatedItem(false), 0.025),
				new Reward(new StrongHardenedLeatherBoots(50).getUpdatedItem(false), 0.025),

				new Reward(new LuckyHardenedLeatherHelmet(50).getUpdatedItem(false), 0.025),
				new Reward(new LuckyHardenedLeatherChestplate(50).getUpdatedItem(false), 0.025),
				new Reward(new LuckyHardenedLeatherLeggings(50).getUpdatedItem(false), 0.025),
				new Reward(new LuckyHardenedLeatherBoots(50).getUpdatedItem(false), 0.025),
				...
				new Reward(new BullSpiritKey().getUpdatedItem(false), 10.0),
