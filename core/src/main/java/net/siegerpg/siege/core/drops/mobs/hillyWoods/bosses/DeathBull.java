...
public class DeathBull extends MobDropTable {
	...
	public DeathBull() {
		...
		super("DeathBull", 37, 40, 46, 49, new Reward[] {
				...
				new Reward(new LeatherHelmet(80).getUpdatedItem(false), 0.50),
				new Reward(new LeatherChestplate(80).getUpdatedItem(false), 0.50),
				new Reward(new LeatherLeggings(80).getUpdatedItem(false), 0.50),
				new Reward(new LeatherBoots(80).getUpdatedItem(false), 0.50),
				...
				new Reward(new ToughDoubleBladedAxe(Utils.randRarity()).getUpdatedItem(false), 0.15),
				new Reward(new LuckyDoubleBladedAxe(Utils.randRarity()).getUpdatedItem(false), 0.15),
				new Reward(new StrongDoubleBladedAxe(Utils.randRarity()).getUpdatedItem(false), 0.15),
				new Reward(new HealingDoubleBladedAxe(Utils.randRarity()).getUpdatedItem(false), 0.15),
				new Reward(new HealthyDoubleBladedAxe(Utils.randRarity()).getUpdatedItem(false), 0.15),
