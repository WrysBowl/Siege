...
public class ScorchingBlob extends MobDropTable {
	...
	public ScorchingBlob() {
		...
		super("ScorchingBlob", 6, 9, 21, 24, new Reward[] {
				...
				new Reward(new MagmaHelmet(50).getUpdatedItem(false), 0.20),
				new Reward(new MagmaChestplate(50).getUpdatedItem(false), 0.20),
				new Reward(new MagmaLeggings(50).getUpdatedItem(false), 0.20),
				new Reward(new MagmaBoots(50).getUpdatedItem(false), 0.20),
