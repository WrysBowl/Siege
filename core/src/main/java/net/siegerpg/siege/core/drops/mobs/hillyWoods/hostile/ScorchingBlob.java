...
public class ScorchingBlob extends MobDropTable {
    public ScorchingBlob() {
        super("ScorchingBlob", 6, 9, 11, 14, new Reward[]{
                ...
                new Reward(new MagmaHelmet(0).getUpdatedItem(false), 5.0),
                new Reward(new MagmaChestplate(0).getUpdatedItem(false), 5.0),
                new Reward(new MagmaLeggings(0).getUpdatedItem(false), 5.0),
                new Reward(new MagmaBoots(0).getUpdatedItem(false), 5.0),
                new Reward(new MatchStick(0).getUpdatedItem(false), 5.0),
