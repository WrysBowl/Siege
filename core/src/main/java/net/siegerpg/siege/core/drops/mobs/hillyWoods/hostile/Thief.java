...
public class Thief extends MobDropTable {
	...
	public Thief() {
		...
		super("Thief", 25, 28, 35, 38, new Reward[] {
				...
				new Reward(new Shank(50).getUpdatedItem(false), 1.5),
				new Reward(new Shank(Utils.randRarity()).getUpdatedItem(false), 2.5),
				new Reward(new ToughShank(Utils.randRarity()).getUpdatedItem(false), 0.25),
				new Reward(new LuckyShank(Utils.randRarity()).getUpdatedItem(false), 0.25),
				new Reward(new StrongShank(Utils.randRarity()).getUpdatedItem(false), 0.25),
				new Reward(new HealingShank(Utils.randRarity()).getUpdatedItem(false), 0.25),
				new Reward(new HealthyShank(Utils.randRarity()).getUpdatedItem(false), 0.25),
