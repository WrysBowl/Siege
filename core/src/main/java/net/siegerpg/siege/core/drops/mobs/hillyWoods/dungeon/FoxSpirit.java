...
public class FoxSpirit extends MobDropTable {
	...
	public FoxSpirit() {
		...
		super("FoxSpirit", 7500, 12500, 65000, 90000, new Reward[] {
				...
				new Reward(new Bone().getUpdatedItem(false).asQuantity(8), 12.0),
				...
				new Reward(new LuckySplinteredBone(Utils.randRarity()).getUpdatedItem(false), 2.0),
				new Reward(new ToughSplinteredBone(Utils.randRarity()).getUpdatedItem(false), 2.0),
				new Reward(new StrongSplinteredBone(Utils.randRarity()).getUpdatedItem(false), 2.0),
				new Reward(new HealingSplinteredBone(Utils.randRarity()).getUpdatedItem(false), 2.0),
				new Reward(new HealthySplinteredBone(Utils.randRarity()).getUpdatedItem(false), 2.0),
				...
				new Reward(new LuckyScrapShard(Utils.randRarity()).getUpdatedItem(false), 2.0),
				new Reward(new ToughScrapShard(Utils.randRarity()).getUpdatedItem(false), 2.0),
				new Reward(new StrongScrapShard(Utils.randRarity()).getUpdatedItem(false), 2.0),
				new Reward(new HealingScrapShard(Utils.randRarity()).getUpdatedItem(false), 2.0),
				new Reward(new HealthyScrapShard(Utils.randRarity()).getUpdatedItem(false), 2.0),
