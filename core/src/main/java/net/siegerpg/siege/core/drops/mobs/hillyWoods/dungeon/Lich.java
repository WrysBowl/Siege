...
public class Lich extends MobDropTable {
	...
	public Lich() {
		...
		super("Lich", 3000, 5500, 25000, 30000, new Reward[] {
				...
				new Reward(new LuckyGreatSword(Utils.randRarity()).getUpdatedItem(false), 0.20),
				new Reward(new ToughGreatSword(Utils.randRarity()).getUpdatedItem(false), 0.20),
				new Reward(new StrongGreatSword(Utils.randRarity()).getUpdatedItem(false), 0.20),
				new Reward(new HealingGreatSword(Utils.randRarity()).getUpdatedItem(false), 0.20),
				new Reward(new HealthyGreatSword(Utils.randRarity()).getUpdatedItem(false), 0.20),
				...
				new Reward(new LuckyFlamingHotTorch(Utils.randRarity()).getUpdatedItem(false), 0.20),
				new Reward(new ToughFlamingHotTorch(Utils.randRarity()).getUpdatedItem(false), 0.20),
				new Reward(new StrongFlamingHotTorch(Utils.randRarity()).getUpdatedItem(false), 0.20),
				new Reward(new HealingFlamingHotTorch(Utils.randRarity()).getUpdatedItem(false), 0.20),
				new Reward(new HealthyFlamingHotTorch(Utils.randRarity()).getUpdatedItem(false), 0.20),
				...
				new Reward(new LuckyEarthernWand(Utils.randRarity()).getUpdatedItem(false), 0.20),
				new Reward(new ToughEarthernWand(Utils.randRarity()).getUpdatedItem(false), 0.20),
				new Reward(new StrongEarthernWand(Utils.randRarity()).getUpdatedItem(false), 0.20),
				new Reward(new HealingEarthernWand(Utils.randRarity()).getUpdatedItem(false), 0.20),
				new Reward(new HealthyEarthernWand(Utils.randRarity()).getUpdatedItem(false), 0.20),
