...
public class Blubber extends MobDropTable {
	...
	public Blubber() {
		...
		super("Blubber", 17, 20, 47, 55, new Reward[] {
				...
				new Reward(new LuckySlimeSpoofer(80).getUpdatedItem(false), 0.10),
				new Reward(new ToughSlimeSpoofer(80).getUpdatedItem(false), 0.10),
				new Reward(new StrongSlimeSpoofer(80).getUpdatedItem(false), 0.10),
				new Reward(new HealingSlimySpoofer(80).getUpdatedItem(false), 0.10),
				new Reward(new HealthySlimeSpoofer(80).getUpdatedItem(false), 0.10),

				new Reward(new SlimeSpoofer(Utils.randRarity()).getUpdatedItem(false), 0.20),
				new Reward(new LuckySlimeSpoofer(Utils.randRarity()).getUpdatedItem(false), 0.10),
				new Reward(new ToughSlimeSpoofer(Utils.randRarity()).getUpdatedItem(false), 0.10),
				new Reward(new StrongSlimeSpoofer(Utils.randRarity()).getUpdatedItem(false), 0.10),
				new Reward(new HealingSlimySpoofer(Utils.randRarity()).getUpdatedItem(false), 0.10),
