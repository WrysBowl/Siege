...
public class Warrior_Dwarf extends MobDropTable {
	...
	public Warrior_Dwarf () {
		...
		super("Warrior_Dwarf", 60, 70, 50, 60, new Reward[] {
				...
				new Reward(Leather.Companion.tier(1).getUpdatedItem(false).asQuantity(8), 60.0),
				new Reward(Leather.Companion.tier(2).getUpdatedItem(false), 15.0),

				new Reward(RefinedMetal.Companion.tier(1).getUpdatedItem(false).asQuantity(3), 25.0),
