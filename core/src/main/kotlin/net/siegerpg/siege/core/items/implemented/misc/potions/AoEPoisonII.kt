...
class AoEPoisonII() : CustomPotion(
		name = "Aura of Poison II",
		customModelData = 820004,
		description = listOf("Mobs within 5 blocks", "are inflicted by poison II"),
		levelRequirement = 0,
	...
	override fun speciality(player : Player) {
		var countDown = 90
		val potion = PotionEffect(PotionEffectType.POISON, 40, 1)
