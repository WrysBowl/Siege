...
object SchematicPaster {
     ...
     * @throws IOException Thrown when the resource can't be read
     */
    public fun pasteSchematic(clipboard: Clipboard, location: Location, ignoreAirBlocks: Boolean) {
        val editSession =
            WorldEdit.getInstance().editSessionFactory.getEditSession(FaweAPI.getWorld(location.world.name), -1)
