...
class Minnow : Shop() {
	...
	override var items: List<ShopItem> = listOf(
		...
		ShopItem(
			MetalScrap.tier(2), -1, hashMapOf(
				MetalScrap.tier(1) to 8
			), true
		) {
			MetalScrap.tier(2).getUpdatedItem(false)
		},
		ShopItem(
			RefinedMetal.tier(2), -1, hashMapOf(
				RefinedMetal.tier(1) to 8
			), true
		) {
			RefinedMetal.tier(2).getUpdatedItem(false)
		},
		ShopItem(
			Titanium.tier(2), -1, hashMapOf(
				Titanium.tier(1) to 8
			), true
		) {
			Titanium.tier(2).getUpdatedItem(false)
		},
		ShopItem(
			RefinedMetal.tier(1), -1, hashMapOf(
				MetalScrap.tier(1) to 8
			), true
		) {
		...
		ShopItem(
			MetalScrap.tier(3), -1, hashMapOf(
				MetalScrap.tier(2) to 8
			), true
		) {
			MetalScrap.tier(3).getUpdatedItem(false)
		},
		ShopItem(
			RefinedMetal.tier(3), -1, hashMapOf(
		...
		ShopItem(
			Titanium.tier(3), -1, hashMapOf(
				Titanium.tier(2) to 8
			), true
		) {
		...
		ShopItem(
			MetalScrap.tier(4), -1, hashMapOf(
				MetalScrap.tier(3) to 8
			), true
		) {
			MetalScrap.tier(4).getUpdatedItem(false)
		},
		ShopItem(
			RefinedMetal.tier(4), -1, hashMapOf(
				RefinedMetal.tier(3) to 8
			), true
		) {
			RefinedMetal.tier(4).getUpdatedItem(false)
		},
		ShopItem(
			Titanium.tier(4), -1, hashMapOf(
				Titanium.tier(3) to 8
			), true
		) {
		...
		ShopItem(
			MetalScrap.tier(5), -1, hashMapOf(
				MetalScrap.tier(4) to 8
			), true
		) {
			MetalScrap.tier(5).getUpdatedItem(false)
		},
		ShopItem(
			RefinedMetal.tier(5), -1, hashMapOf(
				RefinedMetal.tier(4) to 8
			), true
		) {
			RefinedMetal.tier(5).getUpdatedItem(false)
		},
		ShopItem(
			Titanium.tier(5), -1, hashMapOf(
				Titanium.tier(4) to 8
			), true
		) {
