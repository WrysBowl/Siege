...
class Edward : Shop() {
    ...
    override var items: List<ShopItem> = listOf(
        ...
        //Iron LEGGINGS
        ShopItem(IronLeggings(-1), 3750, hashMapOf(
            RefinedMetal.tier(2) to 7), true) {
        ...
        //Iron BOOTS
        ShopItem(IronBoots(-1), 2500, hashMapOf(
            RefinedMetal.tier(2) to 4), true) {
