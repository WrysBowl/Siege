...
class Chip : Shop("Chip", "siege.shops.shop.chip", listOf(
    //LIGHT MELEE
    ...
    ShopItem(
        LuckyStickyStick(-1), 200, hashMapOf(
            Slime.tier(2) to 1,
            Stick.tier(2) to 2,
    ...
    ShopItem(
        StrongStickyStick(-1), 200, hashMapOf(
            Slime.tier(2) to 1,
            Stick.tier(2) to 2,
    ...
    ShopItem(
        ToughStickyStick(-1), 200, hashMapOf(
            Slime.tier(2) to 1,
            Stick.tier(2) to 2,
    ...
    ShopItem(
        HealthyStickyStick(-1), 200, hashMapOf(
            Slime.tier(2) to 1,
            Stick.tier(2) to 2,
    ...
    ShopItem(
        HealingStickyStick(-1), 200, hashMapOf(
            Slime.tier(2) to 1,
            Stick.tier(2) to 2,
    ...
    ShopItem(
        LuckyWoodenBow(-1), 300, hashMapOf(
            Stick.tier(3) to 3,
            Vine.tier(3) to 1,
    ...
    ShopItem(
        StrongWoodenBow(-1), 300, hashMapOf(
            Stick.tier(3) to 3,
            Vine.tier(3) to 1,
    ...
    ShopItem(
        ToughWoodenBow(-1), 300, hashMapOf(
            Stick.tier(3) to 3,
            Vine.tier(3) to 1,
    ...
    ShopItem(
        HealthyWoodenBow(-1), 300, hashMapOf(
            Stick.tier(3) to 3,
            Vine.tier(3) to 1,
    ...
    ShopItem(
        HealingWoodenBow(-1), 300, hashMapOf(
            Stick.tier(3) to 3,
            Vine.tier(3) to 1,
