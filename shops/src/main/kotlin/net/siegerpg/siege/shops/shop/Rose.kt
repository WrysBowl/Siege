...
class Rose : Shop() {
    ...
    override var items: List<ShopItem> = listOf(
        ShopItem(Slime.tier(1).asQuantity(4), -1, hashMapOf(
        ...
        ShopItem(Magma.tier(1).asQuantity(4) as CustomItem, -1, hashMapOf(
            Magma.tier(2) to 1), true) {
            Magma.tier(1).getUpdatedItem(false).asQuantity(4)
        },
        ShopItem(PlantMatter.tier(1).asQuantity(4) as CustomItem, -1, hashMapOf(
            PlantMatter.tier(2) to 1), true) {
            PlantMatter.tier(1).getUpdatedItem(false).asQuantity(4)
        },
        ShopItem(Seed.tier(1).asQuantity(4) as CustomItem, -1, hashMapOf(
        ...
        ShopItem(Pebble.tier(1).asQuantity(4) as CustomItem, -1, hashMapOf(
            Pebble.tier(2) to 1), true) {
        ...
        ShopItem(Magma.tier(2).asQuantity(4) as CustomItem, -1, hashMapOf(
            Magma.tier(3) to 1), true) {
            Magma.tier(2).getUpdatedItem(false).asQuantity(4)
        },
        ShopItem(PlantMatter.tier(2).asQuantity(4) as CustomItem, -1, hashMapOf(
            PlantMatter.tier(3) to 1), true) {
            PlantMatter.tier(2).getUpdatedItem(false).asQuantity(4)
        },
        ShopItem(Seed.tier(2).asQuantity(4) as CustomItem, -1, hashMapOf(
        ...
        ShopItem(Pebble.tier(2).asQuantity(4) as CustomItem, -1, hashMapOf(
        ...
        ShopItem(Magma.tier(3).asQuantity(4) as CustomItem, -1, hashMapOf(
            Magma.tier(4) to 1), true) {
            Magma.tier(3).getUpdatedItem(false).asQuantity(4)
        },
        ShopItem(PlantMatter.tier(3).asQuantity(4) as CustomItem, -1, hashMapOf(
            PlantMatter.tier(4) to 1), true) {
            PlantMatter.tier(3).getUpdatedItem(false).asQuantity(4)
        },
        ShopItem(Seed.tier(3).asQuantity(4) as CustomItem, -1, hashMapOf(
        ...
        ShopItem(Pebble.tier(3).asQuantity(4) as CustomItem, -1, hashMapOf(
        ...
        ShopItem(Magma.tier(4).asQuantity(4) as CustomItem, -1, hashMapOf(
            Magma.tier(5) to 1), true) {
            Magma.tier(4).getUpdatedItem(false).asQuantity(4)
        },
        ShopItem(PlantMatter.tier(4).asQuantity(4) as CustomItem, -1, hashMapOf(
            PlantMatter.tier(5) to 1), true) {
            PlantMatter.tier(4).getUpdatedItem(false).asQuantity(4)
        },
        ShopItem(Seed.tier(4).asQuantity(4) as CustomItem, -1, hashMapOf(
        ...
        ShopItem(Pebble.tier(4).asQuantity(4) as CustomItem, -1, hashMapOf(
            Pebble.tier(5) to 1), true) {
            Pebble.tier(4).getUpdatedItem(false).asQuantity(4)
        },
    )
