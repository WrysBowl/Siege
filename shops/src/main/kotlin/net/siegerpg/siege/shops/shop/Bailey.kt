...
class Bailey : Shop() {
    ...
    override var items: List<ShopItem> = listOf(
        ...
        ShopItem(LuckyPebbleShooter(-1), -1, hashMapOf(
                Pebble.tier(2) to 1,
                Stick.tier(2) to 2,
                Vine.tier(2) to 1,
        ...
        ShopItem(StrongPebbleShooter(-1), -1, hashMapOf(
                Pebble.tier(2) to 1,
                Stick.tier(2) to 2,
                Vine.tier(2) to 3,
        ...
        ShopItem(ToughPebbleShooter(-1), -1, hashMapOf(
                Pebble.tier(2) to 2,
                Stick.tier(2) to 2,
                Vine.tier(2) to 1), true) {
            ToughPebbleShooter(Utils.randRarity()).getUpdatedItem(false)
        },
        ShopItem(HealthyPebbleShooter(-1), -1, hashMapOf(
                Pebble.tier(2) to 1,
                Stick.tier(2) to 2,
                Vine.tier(2) to 1,
        ...
        ShopItem(HealingPebbleShooter(-1), -1, hashMapOf(
                Pebble.tier(2) to 1,
                Stick.tier(2) to 2,
                Vine.tier(2) to 1,
